...
use mfight_sdk::nft::{TokenRarity, TokenCollection, TokenType, TokenSubType, TokenMetadata, NFTContractMetadata, NFT_METADATA_SPEC, NonFungibleTokenMetadataProvider, TokenId, NonFungibleToken};
...
mfight_sdk::impl_non_fungible_token_reveal!(Contract, tokens);
