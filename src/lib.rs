...
use mfight_sdk::nft::{TokenRarity, TokenRarityOld, TokenCollection, TokenType, TokenSubType, TokenMetadata, NFTContractMetadata, NFT_METADATA_SPEC, NonFungibleTokenMetadataProvider, TokenId, NonFungibleToken};
...
enum StorageKey {
    ...
    // Extra info
    TokenRarityOld, //To remove old rarity rename to TokenRarity
    TokenCollection,
    TokenType,
    TokenSubType,
...
impl Contract {
    ...
    pub fn migrate() -> Self {
        ...
        pub struct OldNonFungibleToken {
          ...
          //Remove to end Rarity Migration
          pub token_rarity_by_id_old: Option<LookupMap<TokenId, TokenRarityOld>>,
